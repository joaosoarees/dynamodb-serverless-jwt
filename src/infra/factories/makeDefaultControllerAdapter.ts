...
export function makeDefaultControllerAdapter(controller: GenericAdapterController) {
  return ServerlessAdapter.adapt(new DefaultControllerAdapter().adapt(controller));
}
